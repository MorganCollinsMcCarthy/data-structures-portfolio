...
public class LinkedBinaryTree<E extends Comparable<E>> extends AbstractBinaryTree<E> {
 ...
 protected static class Node<E> implements Position<E> {
  ...
  public void ceateLevelOrder(E [] arr) {
	  root = ceateLevelOrderHelper(arr,root, 0);
  }
  
  private Node<E> ceateLevelOrderHelper(E [] arr, Node<E> p, int i){
	  if(i<arr.length) {
		  Node<E> n = createNode(arr[i], p, null, null);
		  n.left= ceateLevelOrderHelper(arr,n.left,2*i+1);
		  n.right= ceateLevelOrderHelper(arr,n.right,2*i+2);
		  size++;
		  return n; 
	  }
	  return p;
